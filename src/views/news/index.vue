<template>
  <div class="dashboard-container">
    ...
    <el-table :data="tableData" v-loading="loading" border style="width: 100%">
      <el-table-column prop="newsId" label="公司id">
      </el-table-column>
      <el-table-column prop="name" label="名字">
      </el-table-column>
      <el-table-column prop="contentName" label="新闻名字">
      </el-table-column>
      <el-table-column prop="content" label="新闻">
      </el-table-column>
      <el-table-column prop="newsUrl" label="新闻链接">
      </el-table-column>
      <el-table-column prop="time" label="新闻">
      </el-table-column>
    ...
    <el-dialog :title="state==1?'新增':'修改'" :visible.sync="newdialog"   width="30%" :before-close="newClose">
      <el-form ref="newform" :model="newform" label-width="80px">
        ...
        <el-form-item label="新闻名字">
          <el-input v-model="newform.contentName"></el-input>
        </el-form-item>
        <el-form-item label="新闻">
          <el-input v-model="newform.content"></el-input>
        </el-form-item>
        <el-form-item label="新闻链接">
          <el-input v-model="newform.newsUrl"></el-input>
        </el-form-item>
        ...
        <el-form-item label="公司">
           <el-select v-model="newform.newsId" placeholder="请选择">
              <el-option
    ...
    methods: {
     ...
     handleClick(row){
      ...
      establishChecked(){
        ...
        companynews(this.newform).then((res)=>{
          this.newdialog=false
          this.list()
        })
      },
      updateChecked(){
        updatenews(this.newform).then((res)=>{
          this.newdialog=false
          this.resetFields()
          this.list()
        })
